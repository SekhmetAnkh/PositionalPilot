...
public sealed class Plugin : IDalamudPlugin
{
    ...
    private void PrintStatus()
    {
        ...
        services.Chat.Print($"Target: {(snap.HasTarget ? snap.TargetName : "none")}, targetPositionals={positionals}, trueNorth={snap.TrueNorthAvailable}, positional={movement.CurrentPositional}, movement={movement.CurrentMovementPositional} ({movement.CurrentMovementPositionalSource}), border={movement.CurrentBorderSide}, destination={movement.ChosenDestination?.ToString() ?? "none"}, block={movement.BlockReason}, cacheAge={cacheAge}");
